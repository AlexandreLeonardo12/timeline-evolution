 ...
 * Navbar component
 *
 * Renders a fixed top navigation bar with links to the main pages of the site.
 * On mobile viewports a hamburger button is displayed to toggle the mobile
 * menu. The `NavLink` component from `react-router-dom` applies an active
 * style automatically when the link matches the current route. See
 * `src/pages/Index.tsx`, `About.tsx` and `Projects.tsx` for the pages
 * referenced here.
 */
